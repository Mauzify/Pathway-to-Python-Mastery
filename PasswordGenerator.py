...
def check_strength_of_password(length, pool_size):
    entropy = length * math.log2(pool_size)
    percentage = (entropy / 128) * 100
...
def program(): # program function that runs the actual UI.
    ...
    try: 
        ...
        new_password, pool_size = generate_the_damn_password(length, digits, special) 
        strength_score = check_strength_of_password(length, pool_size) 
