...
As of right now, I'm current learning the advanced workflows, writing huge projects, etc.
Currently, my greatest python achievement is a 100% hand written python chess engine, with NNUe, Algorithms, etc.
(PROJECT MOVED TO C++ REPO)
